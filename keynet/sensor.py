...
class OpticalFiberBundle(Keysensor):
    ...
    def load(self, imgfile, h_xtalk=0.05, v_xtalk=0.05, fiber_core_x=16, fiber_core_y=16, do_camera_noise=True):
        ...
        img_sim = keynet.fiberbundle.simulation(img_color, h_xtalk=h_xtalk, v_xtalk=v_xtalk, fiber_core_x=fiber_core_x, fiber_core_y=fiber_core_y, do_camera_noise=do_camera_noise)
